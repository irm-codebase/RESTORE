...
# --------------------------------------------------------------------------- #
def c_capacity_max_annual(model, element_id, y):
...
def c_capacity_transfer(model, element_id, y):
...
def c_capacity_retirement(model, element_id, y):
...
def c_capacity_buildrate(model, element_id, y):
...
# --------------------------------------------------------------------------- #
def c_activity_ramp_up(model, element_id, y, h):
...
def c_activity_ramp_down(model, element_id, y, h):
...
def c_activity_max_annual(model, element_id, y):
...
def c_activity_hourly_min(model, element_id, y, h):
...
def c_activity_hourly_max(model, element_id, y, h):
...
def c_activity_annual_max(model, element_id, y):
...
def c_activity_annual_min(model, element_id, y):
